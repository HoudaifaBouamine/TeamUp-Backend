...
namespace Authentication.CustomIdentityApi.V1;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapIdentityApiV1<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
            ...
            ([FromBody] RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
            ...
            {
                throw new NotSupportedException($"{nameof(MapIdentityApiV1)} requires a user store with email support.");
            }
        ...
        .WithSummary("Complited, you can use Bearer token or cookie")
        .WithOpenApi();
        ...
        .Add(endpointBuilder =>
        {
            ...
            confirmEmailEndpointName = $"{nameof(MapIdentityApiV1)}-{finalPattern}";
        ...
        .WithSummary("Not implimented yet (may be deleted in next version (v2))")
        .WithOpenApi();
